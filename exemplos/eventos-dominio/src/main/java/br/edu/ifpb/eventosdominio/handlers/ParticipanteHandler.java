package br.edu.ifpb.eventosdominio.handlers;

import br.edu.ifpb.eventosdominio.domain.participante.eventos.ParticipanteAtivado;
import br.edu.ifpb.eventosdominio.domain.participante.eventos.ParticipanteRegistrado;
